...
function getRelatedListCardVc(
    ...
    assert.isTruthy(
        relatedVcs,
        `I could not find any related entities on your '${entityId}' detail entity. Make sure you set at least one entity inside the 'relatedEntities' property of your '${entityId}' entity configuration. Also, give it an id of '${relatedId}'.`
    )
    ...
    assert.isTruthy(
        relatedCardVc,
        `I could not find a related entity with the id of '${relatedId}' in your '${entityId} detail entity'. Make sure you set the 'relatedEntities' property of your '${entityId}' entity configuration.`
    )
...
1. Import the ${className} into your SkillView: import { ${className} } from '@sprucelabs/spruce-crud-utils'.
